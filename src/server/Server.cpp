...
void Server::handlePass(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 2) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " PASS " + MSG_NEEDMOREPARAMS);
    return;
  }
...
void Server::handleNick(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 2) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " NICK " + MSG_NEEDMOREPARAMS);
    return;
  }
...
void Server::handleUser(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 5) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " USER " + MSG_NEEDMOREPARAMS);
    return;
  }
...
void Server::handleJoin(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 2) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " JOIN " + MSG_NEEDMOREPARAMS);
    return;
  }
  bool isNewChannel =
...
void Server::handlePing(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 2) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " PING " + MSG_NEEDMOREPARAMS);
    return;
  }
  std::string msg;
...
void Server::handleMode(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 2) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " MODE " + MSG_NEEDMOREPARAMS);
    return;
  }
...
void Server::handleInvite(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 3) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " INVITE " + MSG_NEEDMOREPARAMS);
    return;
  }
...
void Server::handleTopic(Client &client, const std::string &rawMsg,
  ...
  if (tokens.size() < 2) {
    sendMessage(client.getFd(),
                ERR_NEEDMOREPARAMS + " TOPIC " + MSG_NEEDMOREPARAMS);
    return;
  }
  chanIt = _channels.find(tokens[1]);
  if (chanIt == _channels.end()) {
